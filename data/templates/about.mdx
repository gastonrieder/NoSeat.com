...
Over time, I noticed that navigation itself was not a major problem when stepping into a new public transport system - Google Maps is usually good enough. If not, there is always a local alternative. 
...
## What does this site aim to do? 

NoSeat.co is a love letter to public transport. I want to encourage everyone to use public transport as much as possible. 
...
Every city page includes a section on how you can use public transport to explore cities, and a section on general tips when travelling abroad. 
